...
import MaybellineColossalImage from '../../../assets/Eyeliner/MaybellineColossal.svg'
import ProductsDescription from '../ProductsDescription';

const MaybellineColossal = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Maybelline Colossal",
        price: "300",
        DiscountPrice: "250",
        image: MaybellineColossalImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Maybelline Colossal</h1>
...
export default MaybellineColossal