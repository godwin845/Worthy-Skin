...
import MarsEyelinerImage from '../../../assets/Eyeliner/MarsEyeliner.svg'
...
const MarsEyeliner = () => {
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Mars Eyeliner</h1>
