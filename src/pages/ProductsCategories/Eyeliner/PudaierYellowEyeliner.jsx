...
import PudaierYellowEyelinerImage from '../../../assets/Eyeliner/PudaierYellowEyeliner.svg'
import ProductsDescription from '../ProductsDescription';

const PudaierYellowEyeliner = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Pudaier Yellow Eyeliner",
        price: "300",
        DiscountPrice: "250",
        image: PudaierYellowEyelinerImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Pudaier Yellow Eyeliner</h1>
...
export default PudaierYellowEyeliner