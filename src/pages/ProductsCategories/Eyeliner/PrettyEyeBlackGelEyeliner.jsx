...
import PrettyEyeBlackGelEyelinerImage from '../../../assets/Eyeliner/PrettyEyeBlackGelEyeliner.svg'
import ProductsDescription from '../ProductsDescription';

const PrettyEyeBlackGelEyeliner = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Pretty Black Gel Eyelinear",
        price: "300",
        DiscountPrice: "250",
        image: PrettyEyeBlackGelEyelinerImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Pretty Eye Black Eyeliner</h1>
...
export default PrettyEyeBlackGelEyeliner