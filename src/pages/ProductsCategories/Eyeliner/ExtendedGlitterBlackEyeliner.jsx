...
import ExtendedGlitterBlackEyelinerImage from '../../../assets/Eyeliner/ExtendedGlitterBlackEyeliner.svg'
import ProductsDescription from '../ProductsDescription';

const ExtendedGlitterBlackEyeliner = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Extended Glitter Black Eyeliner",
        price: "300",
        DiscountPrice: "250",
        image: ExtendedGlitterBlackEyelinerImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Extended Glitter Black Eyeliner</h1>
...
export default ExtendedGlitterBlackEyeliner