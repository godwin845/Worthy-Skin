...
import GelEyelinerSilverImage from '../../../assets/Eyeliner/GelEyelinerSilver.svg'
import ProductsDescription from '../ProductsDescription';

const GelEyelinerSilverEyelinerBg = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Gel Eyeliner Silver",
        price: "300",
        DiscountPrice: "250",
        image: GelEyelinerSilverImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Gel Eyeliner Silver</h1>
...
export default GelEyelinerSilverEyelinerBg