...
import GelEyelinerRedImage from '../../../assets/Eyeliner/GelEyelinerRed.svg'
import ProductsDescription from '../ProductsDescription';

const GelEyelinerRedEyelinerBg = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Gel Eyeliner Red",
        price: "300",
        DiscountPrice: "250",
        image: GelEyelinerRedImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Gel Red Eyeliner</h1>
...
export default GelEyelinerRedEyelinerBg