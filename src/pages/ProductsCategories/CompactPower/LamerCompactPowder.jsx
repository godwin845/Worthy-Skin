...
import LamerCompactPowderImage from '../../../assets/CompactPower/LamerCompactPowder.svg'
import ProductsDescription from '../ProductsDescription';

const LamerCompactPowder = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Lamer Compact Powder",
        price: "300",
        DiscountPrice: "250",
        image: LamerCompactPowderImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Lamer Compact Powder</h1>
...
export default LamerCompactPowder