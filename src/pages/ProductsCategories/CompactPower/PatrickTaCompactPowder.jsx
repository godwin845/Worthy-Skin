...
import PatrickTaCompactPowderImage from '../../../assets/CompactPower/PatrickTaCompactPowder.svg'
import ProductsDescription from '../ProductsDescription';

const PatrickTaCompactPowder = () => {
  const [product] = useState([
      {
        id: 1,
        name: "PatrickTa Compact",
        price: "300",
        DiscountPrice: "250",
        image: PatrickTaCompactPowderImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>PatrickTa Compact</h1>
...
export default PatrickTaCompactPowder