...
import LaminalightredshadeImage from '../../../assets/Lipstick/Laminalightredshade.svg'
import ProductsDescription from '../ProductsDescription';

const Laminalightredshade = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Lamina Light Red Shade",
        price: "300",
        DiscountPrice: "250",
        image: LaminalightredshadeImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Lamina Light Red</h1>
...
export default Laminalightredshade