...
import GCDarkRedshadeshadelipstickImage from '../../../assets/Lipstick/GCDarkRedshadelipstick.svg'
import ProductsDescription from '../ProductsDescription';

const GCDarkRedshadelipstick = () => {
  const [product] = useState([
      {
        id: 1,
        name: "GC Dark Red Lipstick",
        price: "300",
        DiscountPrice: "250",
        image: GCDarkRedshadelipstickImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>GC Dark Red Lipstick</h1>
...
export default GCDarkRedshadelipstick