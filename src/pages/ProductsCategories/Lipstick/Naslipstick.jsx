...
import NaslipstickImage from '../../../assets/Lipstick/Naslipstick .svg'
...
const Naslipstick = () => {
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Nas Lipstick</h1>
