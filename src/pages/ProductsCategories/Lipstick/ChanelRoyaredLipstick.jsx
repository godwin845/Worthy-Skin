...
import ChanelRoyaredLipstickImage from '../../../assets/Lipstick/ChanelRoyaredLipstick.svg'
import ProductsDescription from '../ProductsDescription';

const ChanelRoyaredLipstick = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Chanel Royal Red",
        price: "300",
        DiscountPrice: "250",
        image: ChanelRoyaredLipstickImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Chanel Royal Red</h1>
...
export default ChanelRoyaredLipstick