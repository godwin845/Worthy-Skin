...
import FentyBeautylipstickImage from '../../../assets/Lipstick/FentyBeautylipstick.svg'
...
const FentyBeautylipstick = () => {
  const [product] = useState([
      {
        ...
        price: "300",
        DiscountPrice: "250",
        image: FentyBeautylipstickImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Fenty Beauty Lipstick</h1>
