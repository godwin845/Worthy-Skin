...
import ChanelNudeshadeLipstickImage from '../../../assets/Lipstick/ChanelNudeshadeLipstick.svg'
import ProductsDescription from '../ProductsDescription';

const ChanelNudeshadeLipstick = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Chanel Nude Shade Lipstick",
        price: "300",
        DiscountPrice: "250",
        image: ChanelNudeshadeLipstickImage,
      },
  ]);
...
export default ChanelNudeshadeLipstick