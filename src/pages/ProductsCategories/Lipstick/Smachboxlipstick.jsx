...
import SmachboxlipstickImage from '../../../assets/Lipstick/Smachboxlipstick.svg'
import ProductsDescription from '../ProductsDescription';

const Smachboxlipstick = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Smachbox Lipstick",
        price: "300",
        DiscountPrice: "250",
        image: SmachboxlipstickImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>SmachBox Lipstick</h1>
...
export default Smachboxlipstick