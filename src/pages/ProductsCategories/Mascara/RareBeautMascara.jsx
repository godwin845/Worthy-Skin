...
import RareBeautMascaraImage from '../../../assets/Mascara/RareBeautMascara.svg'
import ProductsDescription from '../ProductsDescription';

const RareBeautMascara = () => {
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Rare Beauty Mascara</h1>
...
export default RareBeautMascara