...
import ClearToneMascaraImage from '../../../assets/Mascara/ClearToneMascara.svg'
import ProductsDescription from '../ProductsDescription';

const ClearToneMascara = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Clear Tone Mascara",
        price: "300",
        DiscountPrice: "250",
        image: ClearToneMascaraImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Clear Tone Mascara</h1>
...
export default ClearToneMascara