...
import GucciMascara2Image from '../../../assets/Mascara/GucciMascara2.svg'
...
const GucciMascara2 = () => {
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Gucci Mascara</h1>
