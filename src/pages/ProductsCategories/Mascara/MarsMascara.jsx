...
import MarsMascaraImage from '../../../assets/Mascara/MarsMascara.svg'
...
const MarsMascara = () => {
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Mars Mascara</h1>
