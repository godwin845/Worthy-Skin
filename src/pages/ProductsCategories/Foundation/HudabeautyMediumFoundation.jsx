...
import HudabeautyMediumFoundationImage from '../../../assets/Foundation/HudabeautyMediumFoundation.svg'
import ProductsDescription from '../ProductsDescription';

const HudabeautyMediumFoundation = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Huda Beauty Medium Foundation",
        price: "300",
        DiscountPrice: "250",
        image: HudabeautyMediumFoundationImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Huda Beauty Medium foundation</h1>
...
export default HudabeautyMediumFoundation