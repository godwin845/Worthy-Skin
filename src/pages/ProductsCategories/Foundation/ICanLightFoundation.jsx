...
import ICanLightFoundationImage from '../../../assets/Foundation/ICanLightFoundation.svg'
import ProductsDescription from '../ProductsDescription';

const ICanLightFoundation = () => {
  const [product] = useState([
      {
        ...
        price: "300",
        DiscountPrice: "250",
        image: ICanLightFoundationImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>ICan Light Foundation</h1>
...
export default ICanLightFoundation