...
import N7LightFoundationImage from '../../../assets/Foundation/N7LightFoundation.svg'
import ProductsDescription from '../ProductsDescription';

const N7LightFoundation = () => {
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>N7 Light Foundation</h1>
...
export default N7LightFoundation