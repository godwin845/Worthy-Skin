...
import MarsMediumFoundationImage from '../../../assets/Foundation/MarsMediumFoundation.svg'
import ProductsDescription from '../ProductsDescription';

const MarsMediumFoundation = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Mars Medium Foundation",
        price: "300",
        DiscountPrice: "250",
        image: MarsMediumFoundationImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Mars Medium Foundation</h1>
...
export default MarsMediumFoundation