...
import BaimsDarkFoundationImage from '../../../assets/Foundation/BaimsDarkFoundation.svg'
...
const BaimsDarkFoundation = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Baims Dark foundation",
        price: "300",
        DiscountPrice: "250",
        image: BaimsDarkFoundationImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Baims Dark Foundation</h1>
