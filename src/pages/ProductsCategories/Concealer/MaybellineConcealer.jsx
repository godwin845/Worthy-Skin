...
import MaybellineConcealerImage from '../../../assets/Concealer/MaybellineConcealer.svg'
import ProductsDescription from '../ProductsDescription';

const MaybellineConcealer = () => {
  const [product] = useState([
      {
        ...
        price: "300",
        DiscountPrice: "250",
        image: MaybellineConcealerImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Maybelline Concealer</h1>
...
export default MaybellineConcealer