...
import TarteCocealerImage from '../../../assets/Concealer/TarteCocealer.svg'
...
const TarteCocealer = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Tarte Concealer",
        price: "300",
        DiscountPrice: "250",
        image: TarteCocealerImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Tarte Concealer</h1>
       ...
       <ProductsDescription productData={product} />
        ...
        <div>
          <div className='ml-10'>
            ...
            <p className='w-[80%] ml-50 mt-10'>Unveil a radiant, even-toned complexion with the Tarte Radiance Concealer, a lightweight yet high-coverage formula designed to camouflage imperfections while nourishing your skin. This luxurious concealer blends effortlessly, brightening under-eyes, covering blemishes, and smoothing skin texture for a naturally flawless finish.
