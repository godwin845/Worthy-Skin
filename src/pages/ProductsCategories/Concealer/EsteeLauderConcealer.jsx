...
import EsteeLauderConcealerImage from '../../../assets/Concealer/EsteeLauderConcealer.svg'
import ProductsDescription from '../ProductsDescription';

const EsteeLauderConcealer = () => {
  const [product] = useState([
      {
        id: 1,
        name: "Estee Lauder Concealer",
        price: "300",
        DiscountPrice: "250",
        image: EsteeLauderConcealerImage,
      },
  ]);
  ...
  return (
    <div className='bg-[#f7a672] p-1 h-full'>
      <h1 className='mt-35 text-4xl ml-10'>Estee Lauder Concealer</h1>
...
export default EsteeLauderConcealer