...
const About = () => {
  return (
    <div>
      ...
      <div className='absolute bottom-0 top-220'>

        <div className="ml-20 w-[1308px] h-[82px] justify-start text-white text-[52px] font-semibold font-['Akshar']">Welcome to Worthy Skin – Beauty That Loves You Back!<br/><br/></div>

        <div className="pl-10 w-[1331px] justify-start text-white text-[35px] font-semibold font-['Akatab']">At Worthy Skin, we believe that every skin is unique, every tone is beautiful, and every individual is worthy of self-love. Our mission is to empower you with high-quality, skin-friendly cosmetics that enhance your natural beauty while nourishing your skin.</div>

        <br />

        <div className="ml-60  w-[886px] h-[82px] justify-start text-white text-[52px] font-semibold font-['Akshar']">Our Philosophy: Beauty with Purpose 💖</div>
        ...
        <div className="ml-80 w-[633px] h-[82px] justify-start text-white text-[52px] font-semibold font-['Akshar']">What Makes Us Different? ✨</div>
        ...
        <div className="ml-60 w-[776px] h-[82px] justify-start text-white text-[52px] font-semibold font-['Akshar']">Join the Worthy Skin Revolution! 🚀</div>
        ...
        <div className="ml-80 w-[776px] h-[82px] justify-start text-white text-[64px] font-bold font-['Akatab']">Because You Are Worthy💖</div>
