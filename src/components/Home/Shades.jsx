...
const Shades = () => {
  return (
    <div>
      ...
      <div className="absolute top-900 mt-35 lg:mt-10 ml-25 lg:ml-0 w-60 text-[25px] lg:top-650 lg:left-270 lg:w-[437px] justify-start"><span class="text-[#1e1e1e] text-[40px] lg:text-[61px] font-extrabold font-['Akatab']">Your Shade Your Way!</span><span class="text-[#1e1e1e] lg:text-3xl font-extrabold font-['Akatab']"> <br/><br/></span><span class="text-[#1e1e1e] lg:text-3xl font-bold font-['Akatab']">Discover the perfect match with our smart shade detection technology</span></div>
    </div>
  )
}
